    ...
    <main className="px-3 min-[320px]:px-6 md:px-12 py-3 min-[320px]:py-6 md:py-12">
      ...
      <main className="px-6 min-[480px]:px-12">
        ...
        <section className="text-neutral-900/80 mb-4">
          ...
          <p className="mb-2">If you ever need to contact a specific person, we have the perfect solution for you. Simply go to the <Link href="/coaches-and-mentors" className="transition-colors duration-300 text-red-700 hover:text-red-800 focus-visible:text-red-800">Coaches and Mentors</Link> page, find the person you're trying to contact, and click the link next to the text "email," which should be found under their name. Note that only coaches and mentors are listed on this page; for security and privacy reasons, we do not store the information of the children in our program, and there is no way to contact them via our website.</p>
          <i>If you need to call about something concering your own child, please call the number listed on <a href="https://www.susd.org/navajo" target="_blank" rel="noopener noreferrer" className="transition-colors duration-300 text-red-700 hover:text-red-800 focus-visible:text-red-800">Navajo's website</a>.</i>
        </section>
        <main className="flex flex-col flex-wrap justify-center items-center text-center">
          ...
          <main className="w-full lg:w-1/2">
            <section className="mb-4 relative flex flex-wrap items-strech w-full border-2 transition-[border-color] duration-300 focus-within:border-red-700">
              ...
              <div className="p-3 bg-slate-100 fill-neutral-900 transition-[background-color,fill] duration-300 peer-focus:fill-red-700 peer-focus:bg-slate-50 flex items-center justify-center">
            ...
            <section className="mb-4 relative flex flex-wrap items-center w-full border-2 transition-[border-color] duration-300 focus-within:border-red-700">
              ...
              <div className="h-[6ch] p-3 bg-slate-100 fill-neutral-900 transition-[background-color,fill] duration-300 peer-focus:fill-red-700 peer-focus:bg-slate-50 flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 512 512">
            ...
            <section className="relative flex flex-wrap items-strech w-full">
              <button className="w-full overflow-clip text-neutral-900 border-2 px-6 py-3 leading-none border-red-700 font-medium relative transition-colors duration-500 hover:text-slate-100 focus-visible:text-slate-100 before:absolute before:h-full before:w-full before:scale-x-0 before:inset-0 before:bg-red-700 before:-z-[1] before:origin-left before:transition-[transform,transform-origin] before:duration-[500ms,0ms] before:delay-[0ms,500ms] hover:before:scale-x-100 hover:before:origin-right focus-visible:before:scale-x-100 focus-visible:before:origin-right" onClick={SendEmail}>Submit</button>
