      ...
      <main className="px-6 min-[480px]:px-12">
        ...
        <main className="flex flex-col flex-wrap gap-4">
          ...
          <Initiative left title="SiS Roadshow" src="roadshow.webp" alt="SiS volunteers at setup booths helping children discover their interest for the magical world of STEM." imgHeight={1920} imgWidth={2560}>
            <p>Using our fully stocked SiS trailer, we travel to you to make STEM more accessible to schools and communities in the Valley. With our traveling set of experiments and volunteers, from hosting tables at your school science fair to full-scale SiS events, we&apos;re happy to help!</p>
          </Initiative>
          <Initiative title={"Jada Saves the Day \"Read To Me\""} src="jada-reading.webp" alt="SiS volunteer answering the question of a student during a Jada Reading." imgHeight={1920} imgWidth={2560}>
            <p>Jada Saves the Day!,  written and published by one of our own SiS student founders, follows the story of Jada, a little girl with a big love of the sciences as she solves a nefarious cyber crime for her brother&apos;s robotics team. Written for ages in grades K-5, &quot;Jada&quot; introduces young readers to the amazing world of robotics while teaching important lessons about cybersecurity, courage, and integrity. Through our &quot;Read To Me&quot; program, our students have introduced Jada to hundreds of students in schools and clubs throughout greater Phoenix. <InlineLink href="/contact-us">Contact us</InlineLink> to set up a reading session at your location!</p>
          </Initiative>
          <Initiative left title="SiS & the Pandemic" src="pandemic.webp" alt="The SiS team teaching students about STEM through Zoom, despite the difficulties of the pandemic." imgHeight={1707} imgWidth={2560}>
            <p>During the COVID-19 pandemic, the SiS team stayed in action, revising our programs for a virtual world. First Fridays, virtual events hosted on the first Friday of each month, brought STEM into the home. Our annual SiS night continued, in a virtual live event hosted by our SiS team and a panel of industry STEM professionals. <InlineLink href="/initiatives/cybersis">CyberSiS</InlineLink>, our cyber safety program for students in grades 3-5, was also developed during the pandemic, teaching ever more important cybersecurity lessons to classrooms virtually. You can find archives of these events on the <InlineLink href="/archive">SiS archive</InlineLink>.</p>
          </Initiative>
        </main>
      </main>
    </main>
