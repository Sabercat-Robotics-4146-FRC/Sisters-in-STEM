...
export default function PageHeader({ title }) {
  return (
    <header className="relative w-full m-auto px-3 min-[320px]:px-6 md:px-12 text-start mb-6">
      {/* <Image className="absolute inset-0 h-full w-full object-cover -z-[1] brightness-50 rounded-xl sm:rounded-3xl" src={src} alt={title} width={1920} height={1280} priority sizes="90vw" /> */}
