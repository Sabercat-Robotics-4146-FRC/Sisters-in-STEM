...
function ExpandIframe(Event, Source) {
  if (Event?.currentTarget) {
    ...
    ExpandedRoot.render(
      <>
        ...
        <iframe className="h-[75vw] sm:h-[50vw] max-h-[90%] object-contain mb-2 w-[90vw] hidden" ref={IframeRef} src={Source} />
    ...
    setTimeout(async function() {
      ...
      try {
        await new Promise(function(Resolve, Reject) {
          ...
          IframeRef.current.addEventListener("error", Reject);
        });
        ExpandedRoot.render(
          <>
            <button type="button" className="absolute top-0 right-0 mr-2 w-max h-max" onClick={function() {
            ...
            <iframe className="h-[75vw] sm:h-[50vw] max-h-[90%] object-contain mb-2 w-[90vw]" ref={IframeRef} src={Source} />
          </>
        );
      } catch(Err) {
        console.warn(Err);
        ExpandedRoot.render(
          <>
            ...
            <p className="text-white text-xl text-center w-3/4 sm:w-1/2">Error Loading Iframe</p>
          </>
        );
      };
    });
